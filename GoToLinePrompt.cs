    ...
    public partial class GoToLinePrompt : Form {
        ...
        private void buttonGoTo_Click(object sender, EventArgs e) {
            if (controlLineNumberTextBox.Text.IsEmpty()) {
                MessageBox.Show(this, "You must enter a value.", "Dev Python - Goto Line");
                return;
            }
            ...
            if (PotentialLineNumber == 0) {
                MessageBox.Show(this, "Zero (0) is not a valid line number, line numbers start at 1.", "Dev Python - Goto Line");
                return;
            }
